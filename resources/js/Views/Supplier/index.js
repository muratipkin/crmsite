                    ...
                    <div className={"row mt-3"}><div className={"col-12"}>
                        <DataTable
                            ...
                            subHeaderComponent={<SubHeaderComponent
                                action={{uri: () => props.history.push('/tedarikci/ekle'), title: 'YENİ Tedarikçi | Müşteri EKLE', class:'btn btn-success'}}
                                filter={filterItem}
                            />}
                            ...
                            fixedHeader
                            columns={[
                                {name:'Hesap Türü',selector:row => row['supplierTypeString'],sortable:true},
